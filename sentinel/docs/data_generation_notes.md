...
Generated with **seed `15000`** on anchor date `2026-07-22` for full reproducibility.
...
- **Total issues deliberately injected:** 6153
...
| `ground_truth_issues.csv` | Answer key: every injected issue | 6153 |
...
|-----------|-------|--------------------------|
| `mixed_date_format` | 3460 | Corrected (standardized to ISO 8601) |
| `dirty_label` | 1269 | Corrected (auto-normalized) |
| `missing_required_field` | 583 | Review (held for human sign-off) |
| `out_of_range` | 278 | Rejected or Corrected (clamp if recoverable) |
| `future_date` | 240 | Rejected (physically impossible) |
| `duplicate_id` | 185 | Rejected (uniqueness violation) |
| `closed_before_inspection` | 138 | Rejected (logical impossibility) |
